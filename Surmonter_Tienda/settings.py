"""
Django settings for Surmonter_Tienda project.
...
MERCADOPAGO_USAR_PRODUCCION = True  # cambiar a True cuando lances
...
MIDDLEWARE = [
    ...
    #'accesscontrol.middleware.AdminAccessMiddleware',
    #'adminpanelApp.middleware.AdminLoginRedirectMiddleware',
]

#ADMIN_ACCESS_KEY = 'TuClaveSecreta2025!'  # Cambia esto
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'carroApp.context_processors.carrito_total',  # reemplaza APP_NAME por el nombre real de tu app
